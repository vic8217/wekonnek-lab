...
const POLICIES: Record<Exclude<MediaType, 'document'>, MediaPolicy> = {
  ...
  'merchant-banner': { maxBytes: 15 * MB, maxWidth: 2400, maxHeight: 1200, quality: 82, thumbnail: { width: 800, height: 400, quality: 74 } },
  ...
  property: { maxBytes: 15 * MB, maxWidth: 2000, maxHeight: 1500, quality: 82, thumbnail: { width: 500, height: 375, quality: 74 } },
