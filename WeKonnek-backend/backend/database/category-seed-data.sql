-- WeKonnek Category & Sub-Category Seed Data
-- Full 10-category hierarchy for super-app marketplace
--
-- Run this in your Supabase SQL Editor AFTER running:
--   1. schema.sql (or supabase-migration.sql)
--   2. add-group-name-migration.sql
--
-- This script is idempotent - safe to run multiple times.
--
-- NOTE: This will REPLACE existing categories. If you have merchants linked
-- to old category IDs, you may need to re-map them.

-- ============================================================
-- STEP 1: Clear existing sub_categories and categories (safe reset)
-- ============================================================
-- Only uncomment these if you want a full reset:
-- DELETE FROM public.sub_categories;
-- DELETE FROM public.categories;

-- ============================================================
-- STEP 2: Insert 10 Main Categories
-- ============================================================
