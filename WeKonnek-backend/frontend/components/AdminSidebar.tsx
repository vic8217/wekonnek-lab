        ...
        {userType === 'admin' ? (
          <>
            ...
            <Link
              ...
              className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/admin/financial-reconciliation') && !isActive('/admin/financial-reconciliation/reviews')
                  ? 'bg-[#DB0002] text-white'
                  : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link
              href="/admin/financial-reconciliation/reviews"
              className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${
                isActive('/admin/financial-reconciliation/reviews')
                  ? 'bg-[#DB0002] text-white'
                  : 'text-gray-700 hover:bg-gray-100'
              }`}
            >
              ...
              <span className="font-medium">Reconciliation follow-ups</span>
            </Link>
