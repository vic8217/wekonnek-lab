...
export default function NotificationInboxBell({ light = false }: { light?: boolean }) {
  ...
  useEffect(() => { void load(); const timer = window.setInterval(load, 45_000); return () => window.clearInterval(timer); }, [load]);
