...
function ProtectedCoordinatorLayout({ children }: { children: React.ReactNode }) {
	...
	return <div className="min-h-screen overflow-x-hidden bg-[#f4f6f8] lg:pl-[232px]">
