...
type Lead = {
  ...
  status: 'pending' | 'reviewing' | 'approved' | 'rejected'; assignment_status: 'assigned' | 'unassigned';
};
...
export default function MerchantOnboardingPage() {
  ...
  return <div className="w-full">
    <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start"><div><h2 className="text-2xl font-black text-[#071d43]">Merchant Onboarding</h2><p className="mt-1 text-sm text-[#4d6385]">View unassigned applications in your zone and applications assigned to your coordinator account.</p></div><button onClick={load} className="flex h-11 items-center justify-center gap-2 rounded-xl border border-[#ccd8e9] bg-white px-5 text-sm font-black text-[#075cff]"><RefreshCw size={17} /> Refresh</button></div>
