...
export default function MerchantLoginPage() {
	...
	return <main className="grid min-h-screen bg-[#f7f9fc] lg:grid-cols-2">
		<section className="relative hidden overflow-hidden bg-gradient-to-br from-[#061330] to-[#22477f] p-12 text-white lg:flex lg:flex-col">
			<div className="flex items-center gap-3"><Image src="/images/weKonnekLogov1.png" alt="WeKonnek" width={1536} height={1024} priority className="h-14 w-auto" /><div><p className="font-black"><span className="text-[#075cff]">WE</span><span className="text-red-500">KONNEK</span></p><p className="text-[10px] text-slate-400">Merchant Portal</p></div></div>
			<div className="my-auto max-w-xl"><p className="text-sm font-black tracking-[.25em] text-blue-300">BUSINESS OPERATIONS</p><h1 className="mt-7 text-5xl font-black leading-tight">Manage your business.<br />Grow with WeKonnek.</h1><p className="mt-6 text-lg leading-7 text-slate-300">Manage products, orders, reservations, promotions, analytics, staff, branches, and customer relationships in one place.</p></div>
			<p className="text-sm text-slate-400">Restricted to authorized WeKonnek merchants</p>
		</section>
