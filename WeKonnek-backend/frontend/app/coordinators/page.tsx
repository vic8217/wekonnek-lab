...
function CoordinatorHeader() { const portalUrl = usePortalUrl('coordinator'); return <header className="relative flex h-[114px] items-center justify-between border-b border-slate-200 bg-white px-5 lg:px-12"><Link href="/"><Image src="/images/weKonnekLogov1.png" alt="WeKonnek" width={1536} height={1024} priority className="h-24 w-auto" /></Link><nav className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-7 whitespace-nowrap text-[15px] font-semibold xl:flex"><Link href="/">Home</Link><Link href="/for-merchants">For Merchants</Link><Link href="/product-studio">Product Studio</Link><Link href="/coordinators" className="relative font-black text-[#075cff] after:absolute after:-bottom-4 after:left-1/2 after:h-[3px] after:w-12 after:-translate-x-1/2 after:rounded-full after:bg-[#075cff]">For Coordinators</Link><Link href="/contact">Contact</Link></nav><a href={portalUrl} className="rounded-xl bg-[#075cff] px-7 py-4 text-sm font-black text-white shadow-[0_12px_24px_rgba(0,86,255,.24)]">Coordinator Portal</a></header>; }
